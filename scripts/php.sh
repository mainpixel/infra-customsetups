...
#install php 7.1
apt-get -y install php7.1 php7.1-mcrypt php7.1-fpm php7.1-gd php7.1-mysql php7.1-dev php7.1-curl php7.1-mbstring php7.1-dom

#install php 7.0
apt-get -y install php7.0 php7.0-mcrypt php7.0-fpm php7.0-gd php7.0-mysql php7.0-dev php7.0-curl php7.0-mbstring php7.0-dom
